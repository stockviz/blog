...
projectSip(assetReturns, assetWeights, sipFlow, mainTitle, subTitle, sprintf("%s/random.glidePath.B.%s.png", reportPath, equityName))
...
ggsave(sprintf("%s/random.glidePath.IRR.DENSITY.B.%s.png", reportPath, equityName), dpi=600, width=12, height=6, units="in")
...
ggsave(sprintf("%s/random.glidePath.VALUE.DENSITY.B.%s.png", reportPath, equityName), dpi=600, width=12, height=6, units="in")
