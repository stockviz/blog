...
> **Abstract:** Quantitative rotation through SPDR Sector ETFs: 5yr rolling Omega selection delivers best CAGR (12.29%) with Sharpe 0.72 — edging out Sharpe (12.18%). LD minimizes drawdown (40.61%); HD underperforms SPY; 2Y-RBL provides modest smoothing. Indian STCG taxes can negate short-term benefits.
