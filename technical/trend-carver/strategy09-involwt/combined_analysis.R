...
# Reads portfolio-returns-involwt-lo.csv and portfolio-returns-involwt-ls.csv,
...
lo_csv <- sprintf("%s/portfolio-returns-involwt-lo.csv", reportPath)
ls_csv <- sprintf("%s/portfolio-returns-involwt-ls.csv", reportPath)

if (!file.exists(lo_csv)) stop("portfolio-returns-involwt-lo.csv not found — run combined_backtest_lo.R first")
if (!file.exists(ls_csv)) stop("portfolio-returns-involwt-ls.csv not found — run combined_backtest_ls.R first")
...
metrics_tbl |>
  ...
  gtsave(sprintf("%s/comparison-involwt-metrics.html", reportPath))

webshot2::webshot(
  sprintf("%s/comparison-involwt-metrics.html", reportPath),
  sprintf("%s/comparison-involwt-metrics.png", reportPath),
...
Common.PlotCumReturns(lo_vs_bh, "Long-Only Strategies vs B&H",
  ...
  sprintf("%s/comparison-involwt-lo-vs-bh.cumret.png", reportPath), NULL)
...
Common.PlotCumReturns(ls_vs_bh, "Long-Short Strategies vs B&H",
  ...
  sprintf("%s/comparison-involwt-ls-vs-bh.cumret.png", reportPath), NULL)
...
tbl |> gtsave(sprintf("%s/comparison-involwt-annual.returns.html", reportPath))
webshot2::webshot(
  sprintf("%s/comparison-involwt-annual.returns.html", reportPath),
  sprintf("%s/comparison-involwt-annual.returns.table.png", reportPath),
  selector = "table.gt_table", expand = c(10, 10, 10, 10))
...
tbl |> gtsave(sprintf("%s/comparison-involwt-annual.drawdowns.html", reportPath))
webshot2::webshot(
  sprintf("%s/comparison-involwt-annual.drawdowns.html", reportPath),
  sprintf("%s/comparison-involwt-annual.drawdowns.table.png", reportPath),
  selector = "table.gt_table", expand = c(10, 10, 10, 10))
...
tbl |> gtsave(sprintf("%s/comparison-involwt-annual.sharpe.html", reportPath))
webshot2::webshot(
  sprintf("%s/comparison-involwt-annual.sharpe.html", reportPath),
  sprintf("%s/comparison-involwt-annual.sharpe.table.png", reportPath),
  selector = "table.gt_table", expand = c(10, 10, 10, 10))
...
ggsave(sprintf("%s/comparison-involwt-annual.returns.png", reportPath),
