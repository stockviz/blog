...
REPORT_PATH <- "/mnt/data/blog/technical/trend-vix-extended"
...
QUERY_VERSION <- "trend-vix-extended-v1"
...
#
# bhav_index carries occasional bad ticks (a level that spikes >threshold and
# reverts the next day) and one-off re-basings (a one-way jump that persists,
# e.g. a reset to a 1000 base value).
#
