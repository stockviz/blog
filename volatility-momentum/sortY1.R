...
save(symRets, file=sprintf("%s/symRetsY1.Rdata", reportPath))

########################################

symXts <- xts(symRets[,-1], symRets[,1])

Common.PlotCumReturns(symXts, "Momentum", "NIFTY 200 TR", sprintf("%s/sortY1.png", reportPath), NULL)
