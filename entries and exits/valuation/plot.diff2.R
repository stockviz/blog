...
indices<-c('NIFTY IT','NIFTY NEXT 50','NIFTY 50','NIFTY BANK','NIFTY MIDCAP 50','NIFTY MEDIA','NIFTY AUTO','NIFTY COMMODITIES', 'NIFTY FINANCIAL SERVICES', 'NIFTY REALTY') 

startDate<-as.Date("2009-01-02")
endDate<-as.Date("2019-03-15")
lb<-220*3 #3 years
