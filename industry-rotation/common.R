# ═══════════════════════════════════════════════════════════════════════════
#  Common infrastructure for industry rotation backtests
#  Source this from simple.R, staggered-4w.R, etc.
# ═══════════════════════════════════════════════════════════════════════════
...
if (!exists("reportPath")) reportPath <- "."
...
#   freqWeeks: rebalance every N weeks
#   offset:    start rebalancing at (firstIdx + offset) instead of firstIdx
