...
createChart<-function(indexName, startDate){
	data<-sqlQuery(lcon, sprintf("select TIME_STAMP, PX_CLOSE from BHAV_INDEX where index_name='%s' and time_stamp >= '%s'", indexName, startDate))
...
createChart('NIFTY 50',as.Date("1991-01-01"))
createChart('NIFTY MIDCAP 100',as.Date("2002-01-01"))
createChart('NIFTY 50',as.Date("2002-01-01"))