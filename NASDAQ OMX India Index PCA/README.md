...
- `NQINT.SMA_200.png`
- `NQINT.SMA_50.png`
- `factor-loadings.A-SMA_100.png`
- `factor-loadings.A-SMA_200.png`
- `factor-loadings.A-SMA_50.png`
- `factor-loadings.ALL.png`
- `factor-loadings.B-SMA_100.png`
- `factor-loadings.B-SMA_200.png`
- `factor-loadings.B-SMA_50.png`
- `factor-loadings.ROLLING.A-SMA_100.png`
- `factor-loadings.ROLLING.A-SMA_200.png`
- `factor-loadings.ROLLING.A-SMA_50.png`
- `factor-loadings.ROLLING.ALL.png`
- `factor-loadings.ROLLING.B-SMA_100.png`
- `factor-loadings.ROLLING.B-SMA_200.png`
- `factor-loadings.ROLLING.B-SMA_50.png`
